"""Working FastAPI entrypoint based on customer support pattern."""
...
class ConsultingServer(ChatKitServer[dict[str, Any]]):
    ...
    async def respond(
        ...
        # Simple prompt for consulting
        consulting_prompt = f"User request: {message_text}\n\nRespond as a helpful consulting AI assistant."
